...
fcitx_input_method_get_imlist(FcitxInputMethod* im)
{
    ...
    if (value == NULL) {
        ...
        GVariant* result = g_dbus_connection_call_sync(g_dbus_proxy_get_connection(G_DBUS_PROXY(im)),
                           ...
                           "Get",
                           g_variant_new("(ss)", "org.fcitx.Fcitx.Controller", "IMList"),
                           G_VARIANT_TYPE("(v)"),
...
fcitx_input_method_set_imlist(FcitxInputMethod *im, GPtrArray* array)
{
    ...
    GVariant* result = g_dbus_connection_call_sync(g_dbus_proxy_get_connection(G_DBUS_PROXY(im)),
                       ...
                       "org.freedesktop.DBus.Properties",
                       "Set",
                       g_variant_new("(ssv)", "org.fcitx.Fcitx.Controller", "IMList", value),
                       G_VARIANT_TYPE_UNIT,
                       G_DBUS_CALL_FLAGS_NONE,
                       -1,           /* timeout */
                       NULL,
                           ...
                           GError             **error)
{
    FcitxInputMethod* im =  g_initable_new(FCITX_TYPE_INPUT_METHOD,
                                           ...
                                           error,
                                           "g-flags", flags,
                                           "g-name", "org.fcitx.Fcitx",
                                           "g-bus-type", bus_type,
                                           "g-object-path", "/controller",
                                           "g-interface-name", "org.fcitx.Fcitx.Controller",
                                           NULL);
